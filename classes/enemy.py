import random
from .storeItems import StoreItems
...
class Enemy:
    ...
    def __init__(self, kind):
        ...
        if kind == "goblin":
            ...
            self.flying = False
            self.drop = ("gold", 
                         StoreItems("big stick", 10, False, False, True, False, False, 10, 100, 0, True), 
                         StoreItems("cape", 25, False, False, True, False, True, 10, 100, 0, False, True ))  # gold = moneys (1 - 10 per drop)... big stick = +10 dmg ... cape = +10 defense
